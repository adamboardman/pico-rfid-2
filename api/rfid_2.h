/**
 * rfid_2.h - Library to use RFID_2 M5 boards that contain WS18505, which is
 * backwards compatible with MFRC522.
 *
 * Based upon ARDUINO RFID MODULE KIT 13.56 MHZ WITH TAGS I2C BY AROZCAN MFRC522_I2C.h
 * Based on ARDUINO RFID MODULE KIT 13.56 MHZ WITH TAGS SPI Library BY COOQROBOT.
 ...
 * Extended by Tom Clement with functionality to write to sector 0 of UID changeable
 * Mifare cards. Extended by Ahmet Remzi Ozcan with I2C functionality.
 * Author: arozcan @ https://github.com/arozcan/MFRC522-I2C-Library Released into the
 * public domain.
 *
 * Please read this file for an overview and then RFID_2.cpp for comments on
 ...
 * To read and write from MIFARE PICCs, the MIFARE protocol is used after the PICC
 * has been selected. The MIFARE Classic chips and protocol is described in the datasheets:
...
#else
#define rfid_debug(...) do { } while (false)
#endif
...
public:
    ...
    static const int FIFO_SIZE = 64;  // The FIFO is 64 bytes.

    /////////////////////////////////////////////////////////////////////////////////////
    // Functions for setting up the Arduino
    /////////////////////////////////////////////////////////////////////////////////////
    RFID_2(i2c_inst_t *i2c,  uint8_t _address);

    /////////////////////////////////////////////////////////////////////////////////////
    // Basic interface functions for communicating with the MFRC522
    /////////////////////////////////////////////////////////////////////////////////////
    int PCD_WriteRegister(uint8_t reg, uint8_t value) const;
    int PCD_WriteRegister(uint8_t reg, uint8_t count, uint8_t *values) const;
    int PCD_ReadRegister(uint8_t reg) const;
    int PCD_ReadRegister(uint8_t reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0) const;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    int PCD_TransceiveData(uint8_t *sendData, uint8_t sendLen, uint8_t *backData,
                            uint8_t *backLen, uint8_t *validBits = NULL,
                            uint8_t rxAlign = 0, bool checkCRC = false);
    int PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData,
                                 uint8_t sendLen, uint8_t *backData = NULL,
                                 uint8_t *backLen = NULL, uint8_t *validBits = NULL,
                                 uint8_t rxAlign = 0, bool checkCRC = false);
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    int PCD_Authenticate(uint8_t command, uint8_t blockAddr, MIFARE_Key *key,
                          Uid *uid);
    ...
    int MIFARE_Decrement(uint8_t blockAddr, long delta);
    int MIFARE_Increment(uint8_t blockAddr, long delta);
    ...
    int MIFARE_GetValue(uint8_t blockAddr, long *value);
    int MIFARE_SetValue(uint8_t blockAddr, long value);

    /////////////////////////////////////////////////////////////////////////////////////
    // Support functions
    /////////////////////////////////////////////////////////////////////////////////////
    int PCD_MIFARE_Transceive(uint8_t *sendData, uint8_t sendLen,
                               bool acceptTimeout = false);
    void PrintStatusCodeName(uint8_t code);
    int PICC_GetType(uint8_t sak);
    void PICC_PrintTypeName(uint8_t type);
    void PICC_DumpToSerial(Uid *uid);
    void PICC_DumpMifareClassicToSerial(Uid *uid, uint8_t piccType,
                                        MIFARE_Key *key);
    void PICC_DumpMifareClassicSectorToSerial(Uid *uid, MIFARE_Key *key,
                                              uint8_t sector);
    void PICC_DumpMifareUltralightToSerial();
    void MIFARE_SetAccessBits(uint8_t *accessBitBuffer, uint8_t g0, uint8_t g1, uint8_t g2,
                              uint8_t g3);
